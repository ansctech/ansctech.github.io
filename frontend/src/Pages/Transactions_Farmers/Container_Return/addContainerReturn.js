...
import {postContainerReturn, updateContainerReturnState} from '../../../redux/actions/Transactions_Farmers/container-return';
...
const AddContainerReturn = ({modal, isLoading, units, customerGroups}) => {
    ...
    return (
        <>
            <Button type="primary" onClick={() => dispatch(updateContainerReturnState({isModal: true}))}>
            ...
            <Modal
                ...
                onCancel={() => dispatch(updateContainerReturnState({isModal: false}))}
            >
