...
const AddSaleRecord = ({
  ...
  const columns = [
    ...
    {
      title: t(
        "table.transaction-customer.subHeaders.saleRecord.labels.customerName.text"
      ),
      render: (e) => (
        <>
        ...
        >
          <Row justify={"space-between"}>
            <Col span={4}>
              <Item
                label={t(
                  "table.transaction-customer.subHeaders.saleRecord.labels.date.text"
                )}
              >
                <Form.Item
                  name="sale_date"
            ...
            <Col span={4}>
              <Item
                label={t(
                  "table.transaction-customer.subHeaders.saleRecord.labels.nameOfFarmer.text"
                )}
              >
                <Item
            ...
            <Col span={4}>
              <Item
                label={
                  <>
                    {t(
                      "table.transaction-customer.subHeaders.saleRecord.labels.firstUnit.text"
                    )}
                    {" ["}{" "}
                    {
                      units.find(
              ...
              >
                ...
                >
                  <Select
                    ...
                    onChange={(e) => setSelectUnit(JSON.parse(e))}
                  >
          ...
          <Row justify={"space-between"}>
            ...
            <Col span={4}>
              <Item
                label={t(
                  "table.transaction-customer.subHeaders.saleRecord.labels.multiply.text"
                )}
              >
